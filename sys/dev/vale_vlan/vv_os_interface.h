 ...
 * #define vv_list_entry(entry_struct_t)
...
#if defined(__linux__)
#define vv_list_declare(head_struct_t, entry_struct_t) struct list_head
...
#define vv_list_entry(entry_struct_t) struct list_head
...
#define vv_list_entry(entry_struct_t) LIST_ENTRY(entry_struct_t)
